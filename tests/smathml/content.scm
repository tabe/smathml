...
(assert-smathml '(m:matrix)
                (:matrix))
(assert-smathml '(m:matrix (m:matrixrow))
                (:matrix ()))
(assert-smathml '(m:matrix (m:matrixrow (m:cn "1") (m:cn "0") (m:cn "0"))
                           (m:matrixrow (m:cn "0") (m:cn "1") (m:cn "0"))
                           (m:matrixrow (m:cn "0") (m:cn "0") (m:cn "1")))
